...
const FileDrop: React.FC = () => {
  ...
  return (
    <div id="app" className="container" style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', justifyContent: 'center', height: '100vh' }}>
      <header style={{ marginBottom: '20px' }}>
        <div style={{ fontSize: '32px', fontWeight: 'bold', marginBottom: '24px' }}>
          Try NexusAI!
        </div>
        <p style={{ marginBottom: '40px', fontSize: 'small', color: '#4a4a4a' }}>
          NexusAI is ...
        </p>
      </header>
